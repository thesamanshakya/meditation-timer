<template>
    <div>
        <div class="relative bg-sky-700 pb-32 overflow-hidden">
                    ...
                    >
                        ...
                        >
                            <div class="max-w-lg w-full lg:max-w-xs">
                                ...
                                >
                                <div
                                    class="relative text-sky-100 focus-within:text-gray-400"
                                >
                                    <div
            ...
            >
                <div class="absolute inset-0 flex">
                    <div
                        class="h-full w-1/2"
                        style="background-color: #0a527b"
                    ></div>
                    <div
                        class="h-full w-1/2"
                        style="background-color: #065d8c"
                    ></div>
                </div>
        ...
        <main class="relative -mt-32">
            <div
                class="max-w-screen-xl mx-auto pb-6 px-4 sm:px-6 lg:pb-16 lg:px-8"
            >
