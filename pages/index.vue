          ...
          <div class="p-5">
            ...
            <div class="mt-5 pt-7 border-t border-white/10 text-white/70">
              ...
              <p class="font-normal mt-1">
                <a class="text-white underline hover:text-white/80 transition-colors" href="https://saman.com.np">Saman
                  Shakya</a>
    ...
    <div class="w1 flex items-center justify-center pb-2" :class="{ running: isRunning }">
      <div class="text-center flex-1">
        ...
        <div class="text-base top-1/2 right-8 mb-6 z-10 md:-mt-32 md:absolute md:text-lg md:min-[130px]">
          ...
          <ul class="bell-sound flex whitespace-no-wrap justify-center m-0 p-0 rounded-md md:block overflow-hidden">
        ...
        <div class="controls" v-if="!isRunning">
          <ul class="presets m-0 p-0 list-none flex justify-center leading-none pb-7 text-[5.5vw] md:text-[4vh]">
            <li v-for="(preset, index) in presetsList.time" :key="index" class="mb-3 relative mx-2.5 md:mb-4 md:mx-4"
              :class="{
        ...
        <div class="interval mt-3 flex items-center justify-center mb-6 md:mt-4">
          <input type="checkbox" id="interval-switch" :checked="presetsList.intervalBell" @change="toggleIntervalBell"
          ...
          <div class="inline-block align-top relative pl-8">
            <div class="absolute left-0 -top-[3px] pr-3 scale-50 md:scale-75">
              ...
              <div class="w-[50px] h-[50px] overflow-hidden rotate-[135deg] absolute left-full -top-[10px]"
                ...
                <div class="border-[5px] border-white rounded-[50%] w-[25px] h-[25px] top-[35px] left-[35px] absolute">
                </div>
                <div class="border-[5px] border-white rounded-[50%] w-[40px] h-[40px] top-[25px] left-[25px] absolute">
                </div>
              </div>
            </div>
